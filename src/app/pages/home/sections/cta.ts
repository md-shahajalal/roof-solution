...
/**
 * The closing strip over a roof photograph: compact, copy on the left and the
 * two actions on the right. Not brand red: it should read as a confident last
 * word, not an alarm, with the red estimate button as the one bright thing in it.
 */
@Component({
  selector: 'rm-cta',
    ...
    <section class="rm-cta" aria-labelledby="rm-cta-title">
      ...
      <div class="rm-container rm-cta__inner">
        ...
        <div class="rm-cta__actions">
          ...
          <a class="rm-btn rm-btn--outline-light" [href]="telHref">
